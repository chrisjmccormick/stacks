> Baselines live with the project they belong to:
> [`stacks/decoder-medium/baselines/`](stacks/decoder-medium/baselines/README.md) and
> [`stacks/decoder-small/baselines/`](stacks/decoder-small/baselines/README.md).
> The policy below applies to every track.
