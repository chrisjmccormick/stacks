# train_stack-10-table-lr-0.003.py -- stacks@bigram-embeds d75f72d train_stack.py, plus:
# Trying: the bigram table's peak lr 0.9 -> 0.003 and bigram_lambdas' 0.5 -> 0.1; probe_table.py
...
class StackConfig:
    ...
    run_name:        str = "bi_embed_10_table_lr_0.003"  # both wandb and log files
    use_wandb:       bool = True
...
#   name,             weights,       peak lr,  b1_grad,  b2_grad,  wd,       slots
    ...
    ("bigram_embeds", bigram_embeds, 0.003,      0.2,      0.005,    0.001,   1)
]
