# train_stack-09-table-lr-0.01.py -- stacks@bigram-embeds d75f72d train_stack.py, plus:
# Trying: the bigram table's peak lr 0.9 -> 0.01 and bigram_lambdas' 0.5 -> 0.1; probe_table.py
...
class StackConfig:
    ...
    run_name:        str = "bi_embed_09_table_lr_0.01"  # both wandb and log files
    use_wandb:       bool = True
...
#   name,             weights,       peak lr,  b1_grad,  b2_grad,  wd,       slots
    ...
    ("bigram_embeds", bigram_embeds, 0.01,      0.2,      0.005,    0.001,   1)
]
