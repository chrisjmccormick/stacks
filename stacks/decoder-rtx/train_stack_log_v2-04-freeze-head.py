# train_stack_log_v2-04-freeze-head.py
#
# Trying: lm_head alone frozen for steps 0-9 (no update, grads zeroed), then trained on its own
# optimizer clock; input_embeds trains from step 0 as usual.
...
class StackConfig:
    ...
    run_name:        str = "log_v2_04_freeze_head10"  # both wandb and log files
    use_wandb:       bool = True
