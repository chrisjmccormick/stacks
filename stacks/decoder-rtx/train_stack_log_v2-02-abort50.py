# train_stack_log_v2-02-abort50.py
#
# Trying: the v2 control cut at step 50, for a validation figure to compare the two freeze runs against.
...
class StackConfig:
    ...
    run_name:        str = "log_v2_02_abort50"  # both wandb and log files
    use_wandb:       bool = True
