# train_stack-11-lr-0.03-975.py -- train_stack-05-table-lr-0.03.py with num_steps 975. Written by make_steps.py.
...
class StackConfig:
    ...
    run_name:        str = "bi_embed_11_lr_0.03_975"  # both wandb and log files
    use_wandb:       bool = True
