# train_stack-07-lr-0.03-1000.py -- train_stack-05-table-lr-0.03.py with num_steps 1000. Written by make_steps.py.
...
class StackConfig:
    ...
    run_name:        str = "bi_embed_07_lr_0.03_1000"  # both wandb and log files
    use_wandb:       bool = True
