# train_stack_log_v1.py
#
# Trying: stacks@e1e1459 (bigram-embeds) instrumented to study the hashed bigram
# embeddings. Every step it logs the value, grad and bias-corrected m/sqrt_v of a few
# weights in each AdamW parameter (§ Parameter Traces) to the decoder_rtx_bi_embed
# wandb project, and it checkpoints at steps 250, 500, 750 and the end.
#
...
class StackConfig:
    ...
    run_name:        str = "bi_embed_log_v1"  # both wandb and log files
    use_wandb:       bool = True
