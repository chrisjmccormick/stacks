# train_stack-01-no-gates.py -- stacks@bigram-embeds d75f72d train_stack.py, run_name set.
# Trying: the hashed bigram table without the attention gates, with the head init -- the study's first run (traces on, checkpoints at 250/500/750/end).
